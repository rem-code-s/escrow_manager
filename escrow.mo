...
actor class EscrowCanister(projectId: Types.ProjectId, recipientICP: Principal, recipientBTC: Text, nfts: [Types.NFTInfo], endTime : Time.Time, maxNFTsPerWallet : Nat) = this {
